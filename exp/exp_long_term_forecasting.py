...
class Exp_Long_Term_Forecast(Exp_Basic):
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            # self.flag = 1
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in tqdm(enumerate(train_loader),desc="Processing_train{}".format(iter_count)):
                iter_count += 1
    ...
    def test(self, setting, test=0):
        ...
        name=self.args.data_path
        name=name.split('.')[0]
        f = open("result_long_term_forecast_{}.txt".format(name), 'a')
        f.write(setting + "  \n")
